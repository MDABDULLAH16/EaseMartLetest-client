...
const LoginPage = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-4 bg-gray-100 dark:bg-gray-900">
      <div className="w-full max-w-4xl bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="p-8">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="mt-6">
            <div className="mb-4">
              ...
              <input
                ...
                className="w-full px-4 py-2 border rounded-lg focus:ring focus:ring-blue-300 bg-gray-100 dark:bg-gray-700 dark:text-white"
              />
              {errors.email && (
          ...
          <div className="mt-6 text-center">
            <p className="mb-2 text-gray-600 dark:text-gray-300">Or Sign In Using</p>
