...
const ReviewCard = () => {
  ...
  <div className="max-w-screen-xl mx-auto">
    <h2 className="font-black text-black text-center text-3xl leading-none uppercase max-w-2xl mx-auto mb-12">What Listeners
      Are Saying</h2>
    <div className="flex flex-col space-y-4 md:space-y-0 md:flex-row md:space-x-4 relative">
      <div className="bg-gray-200 rounded-lg p-8 text-center md:w-1/3">
        ...
        <p className="text-xl font-light italic text-gray-700">This podcast is amazing! The storytelling and production
          quality are top-notch. I can not wait for the next episode!</p>
      ...
      <div className="bg-gray-200 rounded-lg p-8 text-center md:w-1/3">
        ...
        <p className="text-xl font-light italic text-gray-700">This podcast kept me on the edge of my seat. Its a
      ...
      <div className="bg-gray-200 rounded-lg p-8 text-center md:w-1/3">
        ...
        <p className="text-xl font-light italic text-gray-700">I cant get enough of this podcast! The hosts voice is so
