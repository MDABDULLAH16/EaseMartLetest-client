          ...
          <div className="flex flex-col space-y-4 md:space-y-0 md:flex-row md:space-x-4 relative">
            <div className="bg-gray-200 rounded-lg p-8 text-center md:w-1/3">
              ...
              <p className="text-xl font-light italic text-gray-700">
                ...
                are top-notch. I can not wait for the next episode!
              </p>
            ...
            <div className="bg-gray-200 rounded-lg p-8 text-center md:w-1/3">
              ...
              <p className="text-xl font-light italic text-gray-700">
                This podcast kept me on the edge of my seat. Its a must-listen
            ...
            <div className="bg-gray-200 rounded-lg p-8 text-center md:w-1/3">
              ...
              <p className="text-xl font-light italic text-gray-700">
                I cant get enough of this podcast! The hosts voice is so
                soothing, and the stories are gripping. Highly recommend!
              </p>
              <div className="flex items-center justify-center space-x-2 mt-4">
                <svg
                  className="text-yellow-500 w-4 h-4"
