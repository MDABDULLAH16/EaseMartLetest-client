...
const ReviewForm: React.FC<ReviewFormProps> = ({ productId }) => {
  ...
  return (
    <div className="p-4 mx-auto bg-white dark:bg-[#383838] rounded-lg shadow-md max-w-4xl sm:p-6 grid grid-cols-1 lg:grid-cols-6 gap-6">
      <div className="lg:col-span-4 col-span-1">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <textarea
            ...
            rows={4}
            required
            maxLength={140} // Set the character limit to 140
            className="block w-full p-3 text-sm text-gray-900 dark:text-white bg-gray-50 dark:bg-gray-700 rounded-md border border-gray-300 dark:border-gray-600 focus:ring-blue-500 focus:border-blue-500"
            placeholder="Write your review"
            value={review}
            onChange={(e) => setReview(e.target.value)}
          ></textarea>
          <p className="text-sm text-gray-500 dark:text-gray-400">{review.length}/140 characters</p>
